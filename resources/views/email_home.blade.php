...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4 relative overflow-auto">
    ...
    <div class="w-full max-w-lg relative z-10">
        <!-- Main Card -->
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 relative overflow-hidden">
            ...
            <div class="text-center mb-6 relative">
                <div class="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-2xl mb-2 shadow-lg">
                    <i class="fas fa-envelope text-xl text-white"></i>
                </div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent mb-1">
                    Send Email
                </h1>
                <p class="text-white/70 text-base">Share your thoughts with the world</p>
            </div>

            <!-- Form -->
            <form class="space-y-4 relative" method="post">
                @csrf
            ...
            @endif
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        ...
                        <div class="h-3 text-red-300 text-sm flex items-center ">
                        @error('email')
                ...
                <!-- Subject Input -->
                <div class="group">
                    <label class="block text-white/90 text-sm font-semibold mb-2 flex items-center" for="subject">
                ...
                <div class="group">
                    <label class="block text-white/90 text-sm font-semibold mb-2 flex items-center" for="send_times">
                ...
                <!-- Message Textarea -->
                <div class="group">
                    <label class="block text-white/90 text-sm font-semibold mb-2 flex items-center" for="message">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute right-4 top-3 text-purple-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <button type="submit" name="submit"
                    class="w-full bg-gradient-to-r from-purple-600 via-purple-500 to-cyan-500 text-white font-bold py-3 px-8 rounded-2xl shadow-2xl hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-purple-500/50 relative overflow-hidden group mt-6">
